...
<!-- <form name='f1' action=''> -->
<!-- <input type='button' name='b1' value='Logout' onclick='return chkAndSubmit(this)'/> -->
<!--  <input type='button' name='b2' value='Book'> -->
 
<!--  function chkAndSubmit(ele) -->
<!--   {  -->
<!--   if(ele.getArrtibute('name')=='b1') -->
<!--   { -->
<!--   document.f1.setAttribute("action","Login.jsp") -->
<!--   document.f1.submit(); -->
<!--   }else -->
<!--   document.f1.setAttribute("action","HomeServlet.jsp") -->
<!--   document.f1.submit(); -->
<!--   } -->
